        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="form-group">
                    ...
                    {!! Form::text('title', $post->title, ['class' => 'form-control', 'placeholder' => 'Tiêu đề', 'autocomplete' => 'off']) !!}
                </div>
                <div class="form-group">
                    <label>Nội dung bài viết</label>
                    {!! Form::textarea('content', $post->content, ['class' => 'form-control','id' => 'contentEditor','placeholder' => 'Nội dung bài viết']) !!}
                </div>

                <div class="form-group">
                    <label >Tiêu đề SEO</label>
                    {!! Form::text('seo_title', $post->seo_title, ['class' => 'form-control', 'placeholder' => 'Tiêu đề SEO', 'autocomplete' => 'off']) !!}
                </div>
                <div class="form-group">
                    <label >Mô tả SEO</label>
                    {!! Form::textarea('seo_description', $post->seo_description, ['class' => 'form-control', 'rows' => 3, 'placeholder' => 'Mô tả SEO']) !!}
                </div>
                <div class="form-group">
                    <label >Từ khóa SEO</label>
                    {!! Form::text('seo_keywords', $post->seo_keywords, ['class' => 'form-control', 'placeholder' => 'Từ khóa SEO', 'autocomplete' => 'off']) !!}
                </div>
