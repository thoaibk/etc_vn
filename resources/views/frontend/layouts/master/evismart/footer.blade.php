        ...
        <div class="row">
            <div class="col-md-7">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="footer-1">
                            <h3 class="footer1-title text-white mb-3">Công ty</h3>
                    ...
                    <div class="col-md-4">
                        <div class="footer-1">
                            <h3 class="footer1-title text-white mb-3">Support</h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="coppy-right footer-link">
                    <p class="">Copyright © 2020&nbsp; <a class="footer-link" href="#" target="_blank">EviSmart inc</a></p>
                </div>
            </div>
        </div>
    </div>
